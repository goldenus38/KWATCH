...
```
  ...
  │                  │          │                         Docker Compose                                  │
  │   관제실 대시보드  │          │  ┌────────────────────────────────────────────────────────────────────┐  │
  │   (전광판/키오스크) │  HTTP    │  │                        Next.js Frontend                           │  │
  │                  │ ◀────── │  │  Dark Theme 대시보드 │ 스크린샷 그리드 │ 실시간 알림 │ 관리 화면   │  │
  │  ┌────────────┐  │  :3000   │  │  자동 로테이션       │ 상세 팝업       │ 키오스크 모드              │  │
  │  │ 정상  487   │  │          │  └──────────┬──────────────────────────────┬──────────────────────────┘  │
  │  │ 경고    8   │  │          │             │ REST API                     │ WebSocket (Socket.IO)       │
  │  │ 장애    3   │  │          │             ▼                              ▼                             │
  │  │ 위변조  2   │  │          │  ┌──────────────────────────────────────────────────────────────────┐   │
  │  └────────────┘  │          │  │                      Express Backend (:3001)                     │   │
  └──────────────────┘          │  │                                                                  │   │
                                │  │  ┌──────────┐  ┌──────────┐  ┌──────────┐  ┌────────────────┐   │   │
  ┌──────────────────┐          │  │  │ Auth     │  │ Website  │  │ Alert    │  │ Monitoring     │   │   │
  │   관리자 PC       │          │  │  │ (JWT)    │  │ CRUD API │  │ Service  │  │ Status API     │   │   │
  │  웹사이트 관리     │          │  │  └──────────┘  └──────────┘  └──────────┘  └────────────────┘   │   │
  │  카테고리 관리     │          │  │                                                                  │   │
  │  설정 관리        │          │  │  ┌──────────────────────────────────────────────────────────┐    │   │
  └──────────────────┘          │  │  │                    BullMQ Workers                        │    │   │
                                │  │  │                                                          │    │   │
                                │  │  │  ┌─────────────┐  ┌─────────────┐  ┌──────────────────┐ │    │   │
                                │  │  │  │ Monitoring  │  │ Screenshot  │  │ Defacement       │ │    │   │
                                │  │  │  │ Worker      │  │ Worker      │  │ Worker           │ │    │   │
                                │  │  │  │             │  │             │  │                  │ │    │   │
                                │  │  │  │ HTTP HEAD/  │  │ Playwright  │  │ 3계층 하이브리드  │ │    │   │
                                │  │  │  │ GET 상태체크 │  │ 스크린샷     │  │ 위변조 탐지      │ │    │   │
                                │  │  │  │ 응답시간 측정│  │ 팝업 자동제거│  │                  │ │    │   │
                                │  │  │  └─────────────┘  │ HTML 캡처   │  │ L1: 도메인 감사  │ │    │   │
                                │  │  │                   └──────┬──────┘  │ L2: 구조 해시    │ │    │   │
                                │  │  │                          │         │ L3: 픽셀 비교    │ │    │   │
                                │  │  │                          ▼         └──────────────────┘ │    │   │
                                │  │  │                   스크린샷 저장소                        │    │   │
                                │  │  │                   (current/baselines/diffs/thumbnails)  │    │   │
                                │  │  └────────────────────────────────────────────────────────┘    │   │
                                │  └───────────────────────┬──────────────────┬─────────────────────┘   │
                                │                          │                  │                          │
                                │              ┌───────────▼──────┐  ┌───────▼────────┐                 │
                      ...
                      ┌──────────────────────────────────────────────────────────────────┐
                      │                          알림 채널                                │
                      │   📧 Email (SMTP)    💬 Slack (Webhook)    📱 Telegram (Bot)     │
                      └──────────────────────────────────────────────────────────────────┘
```
